...
<option value="https://mingle-ionapi.inforcloudsuite.com/GRANTTHORNTON_DEM/LAWSONGHR/hcm/soap/classes/Employee/lists/_generic?_fields=_all&_limit=5&_out=XML">GHR Employee class REST _generic list</options>
					</select>
				</div>
				<br>
				<div>
